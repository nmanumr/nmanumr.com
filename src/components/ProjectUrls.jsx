...
export default function ProjectUrls({
  ...
  if (codeUrl) {
    ...
    if (parts.length > 4) codeUrlTitle += `/${parts[4]}`;
    ...
    <>
      <div className="sm:col-span-1">
        ...
        <dd className="text-gray-900 mt-1 text-sm">
          {codeUrl ? (
            <a href={codeUrl} className="inline-flex items-center space-x-1">
              <GithubIcon />
              <span>{codeUrlTitle}</span>
            </a>
          ) : (
            <a href={siteUrl} className="inline-flex items-center space-x-1">
              <GlobeIcon />
              <span>{siteText}</span>
            </a>
          )}
      ...
      {!codeUrl || !siteUrl ? (
        ...
        <div>
          <dt className="text-gray-500 text-sm font-medium">Live</dt>
          <dd className="text-gray-900 mt-1 text-sm">
            <a href={siteUrl} className="inline-flex items-center space-x-1">
              <GlobeIcon />
              <span>{siteText}</span>
