...
<video
  class="border-gray-200 mx-auto w-full max-w-sm rounded-lg border md:float-right md:ml-4"
  autoplay
  muted
  loop
  playsinline
...
<div class="text-sm">
  * <b>Why it's not PlayStore's link?</b> This was one of many issues that
  happened with this project, we lost our play store account.
</div>
...
<video
  class="border-gray-200 mx-auto w-full max-w-md rounded-lg border"
  autoplay
  muted
  loop
  playsinline
